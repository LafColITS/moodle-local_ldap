...
/**
 * PHPUnit tests for local_ldap and Active Directory.
 *
 * @package   local_ldap
 * @copyright 2024 Lafayette College ITS
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class sync_ad_test extends sync_base_testcase {
    ...
    protected function get_ldap_user_object_classes(): array {
        return ['inetOrgPerson', 'eduPerson', 'organizationalPerson', 'person', 'posixAccount'];
    }
    ...
    /**
     * Return the approrpiate test OU.
     *
